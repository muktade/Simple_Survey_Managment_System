...
public class SplashScreen extends javax.swing.JDialog {
    ...
    public SplashScreen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        getContentPane().setBackground(new Color(68,108,178));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/app.png"))); // NOI18N
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    doTask("Exicute ...", 20);
                    doTask("Getting Table ...", 30);
                    doTask("Getting Table Value ...", 40);
                    doTask("Opening Module ...", 50);
                    doTask("Opening App ...", 60);
                    doTask("All Done ...", 70);
                    doTask("Checking Info ...", 80);
